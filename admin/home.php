...
$query = "SELECT 
            e.evaluation_id, e.subject_id, sub.subject,
            std.firstname AS 'First Name', std.lastname AS 'Last Name',
            ea.rate AS 'Eva', ql.question,
            eval_counts.rate_5_count, eval_counts.rate_4_count,
            eval_counts.rate_3_count, eval_counts.rate_2_count,
          ...
          ) AS eval_counts ON ea.question_id = eval_counts.question_id;";
...
<head>
    ...
    <style>
        ...
        .text-number {
            font-size: 1.5rem; /* Increase font size for numbers */
            margin: 0.5rem 0;
        }
        .text-description {
...
<body>
    <div class="flex flex-row justify-between p-4 bg-background rounded-lg shadow-md">
        <div class="flex flex-col items-center bg-card p-4 m-2 rounded-lg w-1/4">
            <img class="icon" aria-hidden="true" alt="faculties-icon" src="https://www.flaticon.com/free-icon/user_1077114" />
            <h2 class="text-number text-foreground">|1|</h2>
            <p class="text-description text-muted-foreground">Total Faculties</p>
        </div>
        <div class="flex flex-col items-center bg-card p-4 m-2 rounded-lg w-1/4">
            <img class="icon" aria-hidden="true" alt="students-icon" src="https://openui.fly.dev/openui/24x24.svg?text=👩‍🎓" />
            <h2 class="text-number text-foreground">|3|</h2>
            <p class="text-description text-muted-foreground">Total Students</p>
        </div>
        <div class="flex flex-col items-center bg-card p-4 m-2 rounded-lg w-1/4">
            <img class="icon" aria-hidden="true" alt="users-icon" src="https://openui.fly.dev/openui/24x24.svg?text=👥" />
            <h2 class="text-number text-foreground">|1|</h2>
            <p class="text-description text-muted-foreground">Total Users</p>
        </div>
        <div class="flex flex-col items-center bg-card p-4 m-2 rounded-lg w-1/4">
            <img class="icon" aria-hidden="true" alt="classes-icon" src="https://openui.fly.dev/openui/24x24.svg?text=📚" />
            <h2 class="text-number text-foreground">|3|</h2>
            <p class="text-description text-muted-foreground">Total Classes</p>
        </div>
    </div>
</body>
</html>
